...
function displayAllCategory() {
  let card = categoryProducts.map((item) => {
...
let shoppingCartTitle = document.querySelector(".shopping-cart .cart .item-info h3");
let shoppingCartdesc = document.querySelector(".shopping-cart .cart .item-info p");
...
function addCart(x){
  ...
  if(localStorage.getItem("name")){
    ...
    shoppingCartTitle.innerHTML = choosenItem.title
  }else{
